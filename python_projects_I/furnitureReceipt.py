#printing customer receipts for a furniture store -codecademy
...
# test customer checkouts
# test 1
customer_one_total = customer_one_total + lovely_loveseat_price
customer_one_itemization = lovely_loveseat_description


# print(str(customer_one_total) + " " + customer_one_itemization)
...
# print(str(customer_one_total) + " Grand Total")
